...
def color_rec(source):
    ...
    return colors[0], colors[2], rgb[0], rgb[2], colors[1], rgb[1], result #alphanum_string, shape_string, alphanum_rgb, shape_rgb 


#Testing code
#alphanum_string, shape_string, alphanum_rgb, shape_rgb, third_string, third_rgb, result = color_rec('test1.png')
